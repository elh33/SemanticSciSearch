...
const SearchResults: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* BARRE JAUNE EN HAUT */}
      <div style={{ backgroundColor: '#fbbf24', height: '20px' }} className="w-full"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="flex items-center justify-between gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex-1 max-w-4xl">
              <div className="flex shadow-2xl" style={{ border: '5px solid #fbbf24', borderRadius: '12px', backgroundColor: 'white' }}>
                <input
                  type="text"
                  value={query}
                  onChange={(e) => setQuery(e.target.value)}
                  placeholder="Rechercher des articles scientifiques..."
                  className="flex-grow px-8 py-5 text-xl outline-none"
