...
const SearchResults: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div style={{ backgroundColor: '#3883c5ff' }} className="w-full sticky top-0 z-1000 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center justify-between gap-6">
            {/* Espace vide à gauche pour centrer la barre */}
            <div className="flex-1"></div>
            
            {/* Barre de recherche au centre - ZONE PLUS GRANDE */}
            <form onSubmit={handleSubmit} className="flex-1 max-w-4xl">
              <div className="flex shadow-2xl" style={{ border: '4px solid #fbbf24', borderRadius: '12px', backgroundColor: 'white' }}>
                <input
                  type="text"
                  value={query}
