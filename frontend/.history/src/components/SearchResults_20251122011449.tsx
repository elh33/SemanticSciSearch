    ...
    <div className="min-h-screen bg-white">
        ...
        <div style={{ 
          ...
          <div className="max-w-5xl mx-auto px-4" style={{ paddingLeft: '10px' }}>
            <p className="text-sm text-gray-600">
              Environ {results.length} résultat{results.length !== 1 ? 's' : ''}{searchedQuery && ` pour "${searchedQuery}"`}
            </p>
          </div>
        </div>
      )}
              ...
              <>
                <div>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ paddingLeft: '10px' }}>Année</div>
                    <div>Auteurs</div>
                    <div>Article</div>
                  ...
                  <div style={{ 
                    ...
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((pageNumber) => (
                      <button
                        ...
                        style={{
                          padding: '8px 12px',
                          backgroundColor: currentPage === pageNumber ? '#1a73e8' : 'white',
                          border: '1px solid #dfe1e5',
                          borderRadius: '4px',
                          cursor: 'pointer',
                          color: currentPage === pageNumber ? 'white' : '#5f6368',
                          fontSize: '14px',
      ...
      <footer className="mt-12 border-t border-gray-200 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 py-6 text-center text-sm text-gray-500">
          SemanticSciSearch - Recherche sémantique d'articles scientifiques en IA et Médecine (cardiaque, cancer, diabète, respiratoire)
        </div>
      </footer>
    </div>
  );
