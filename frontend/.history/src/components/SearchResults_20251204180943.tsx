...
oussama tahirijhhucx2egt;iudcv; 9u2ecdtgv92e68sxo86
  return (
    <div className="min-h-screen bg-white">
      {/* Yellow bar */}
      <div style={{ backgroundColor: '#eb17e8ff', height: '30px' }} className="w-full"></div>

      {/* Blue header with search form */}
      <div style={{ backgroundColor: '#3f31bdff' }} className="w-full sticky top-0 z-10 shadow-lg">
          ...
          <>
            ...
            {hasSearched && results.length > 0 && (
              <div style={{ 
                ...
                <div>Authors</div>
                <div>Article</div>
                <div style={{ textAlign: 'center' }}>Abstract</div>
              </div>
            )}
