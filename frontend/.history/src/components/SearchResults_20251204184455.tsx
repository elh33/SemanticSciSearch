...
import logoImage from '../assets/logosm.jpg';
...
const SearchResults: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div style={{ backgroundColor: '#0a2540' }} className="w-full sticky top-0 z-10 shadow-lg">
        {/* Logo Section */}
        <div style={{ 
          display: 'flex', 
          ...
          <img 
  src={`${window.location.origin}/logosm.jpg`}
  alt="SemanticSciSearch Logo" 
  style={{ 
    height: '80px',
    width: 'auto'
  }}
/>
      ...
      <footer className="mt-12 border-t border-gray-200" style={{ backgroundColor: '#0a2540' }}>
        <div className="max-w-5xl mx-auto px-4 py-6 text-center text-sm" style={{ color: '#17a2b8' }}>
