...
import ssLogo from '../assets/SSLOGO'; // Ajustez l'extension (.png, .jpg, .svg, etc.)
...
const SearchResults: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header avec logo et barre de recherche #0dc5b9 */}
      <div style={{ backgroundColor: '#30ece0ff' }} className="w-full sticky top-0 z-10 shadow-lg">
        {/* Logo Section */}
        <div className="min-h-screen bg-white">
    {/* Barre de logo SSLOGO pleine largeur */}
    <div style={{ 
      width: '100%',
      backgroundColor: '#0a2540', // Ou la couleur de votre choix
      display: 'flex',
