...
const SearchResults: React.FC = () => {
  ...
  <div style={{ 
    ...
    />
        ...
        {/* Search Form */}
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0 16px 15px 10px' }}>
      ...
      {/* Footer */}
      <footer className="mt-12 border-t border-gray-200" style={{ backgroundColor: '#17a2b8' }}>
        <div className="max-w-3xl mx-auto px-4 py-6 text-center text-sm" style={{ color: '#1800ad' }}>
          SemanticSSearch - Semantic search for scientific articles in AI and Medicine
        </div>
      </footer>
    </div>
  );
